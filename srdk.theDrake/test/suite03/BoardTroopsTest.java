...
public class BoardTroopsTest {
	...
	public void placingTroops() {
		...
		// První stráž
		Troop clubman1 = new Troop("Clubman", Collections.emptyList(), Collections.emptyList());
		...
		// Druhá stráž
		Troop clubman2 = new Troop("Clubman", Collections.emptyList(), Collections.emptyList());
		...
		Troop spearman = new Troop("Spearman", Collections.emptyList(), Collections.emptyList());
	...
	public void movingTroops() {
		...
		Troop drake = new Troop("Clubman", Collections.emptyList(), Collections.emptyList());
		Troop clubman1 = new Troop("Clubman", Collections.emptyList(), Collections.emptyList());
		Troop clubman2 = new Troop("Clubman", Collections.emptyList(), Collections.emptyList());
		Troop spearman = new Troop("Spearman", Collections.emptyList(), Collections.emptyList());
